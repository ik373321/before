class TweetsTag
  ...
  def save
    tweet = Tweet.create(title: title, risk_id: risk_id, country_id: country_id, city: city, block: block, year: year, month: month,
                         day_id: day_id, time: time, detail: detail, user_id: user_id)
